        ...
        DataReader* reader)
{
    ...
    if (reader->take_next_sample(&st, &info) == ReturnCode_t::RETCODE_OK)
    {
        if (info.valid_data)
        {
            ...
            {
                fastMessages++;
                std::cout << "Sample received from a writer, count=" << fastMessages << ", message: " << st.message()[0] << std::endl;
                // st.message();
                // std::cout << "Sample received from a writer, message: " << st.message()[0] << std::endl;
            ...
            {
                slowMessages++;
                std::cout << "Sample received from b writer, count=" << slowMessages << ", message: " << st.message()[0] << std::endl;
                // st.message();
                // std::cout << "Sample received from b writer, message: " << st.message()[0] << std::endl;
                // for (auto it = st.message().begin(); it != st.message().end(); ++it )
                //     std::cout << ' ' << *it;
                // std::cout << '\n';
            }
